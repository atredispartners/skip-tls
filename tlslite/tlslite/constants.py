...
class CipherSuite:
    ...
    # don't actually support these? but i can pretend i do for skiptls
    ...
    #certSuites.append(TLS_DHE_RSA_WITH_AES_128_CBC_SHA)
    ...
    skipTlsSuites = []
    #skipTlsSuites.append(TLS_DHE_RSA_WITH_AES_128_CBC_SHA)
    skipTlsSuites.append(TLS_RSA_WITH_AES_128_CBC_SHA)
    skipTlsSuites.append(TLS_RSA_WITH_AES_256_CBC_SHA)
    # others?

    @staticmethod
    def getCertSuitesSkipTls(settings):
        return CipherSuite._filterSuites(CipherSuite.skipTlsSuites, settings)
